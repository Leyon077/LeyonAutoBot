...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001813657151,-1001581645367') # request channel id ( make sure bot is admin )
...
LANGUAGES = ["tamil", "", "malayalam", "", "english", "", "hindi", "", "telugu", "", "kannada", "", "korean", "", "spanish", "", "punjabi", ""]
